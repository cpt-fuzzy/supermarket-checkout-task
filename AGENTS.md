...
This file defines the core principles that apply to all code in this repository.
For detailed reference material, see:

- `docs/core.md` — Project structure, infrastructure (Docker, CI)
- `docs/backend.md` — Java / Spring Boot style and conventions
- `docs/frontend.md` — TypeScript / Angular style and conventions
